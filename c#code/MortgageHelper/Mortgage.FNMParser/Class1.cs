            ...
            this.childArrays.ToList().ForEach(c => {
                fnmString.Where(t => t.IndexOf(c.Id) == 0).ToList().ForEach(f => {
                    if (c.IsArray) {
                        ...
                        PropertyInfo prop = type.GetProperty(this[c.Name]);
...
public class HousingExpense {
    ...
    */
    ...
    string  ExpenseIndicatorValue{get{
